...
const int nhist = 1000; // numero de historias
...
int main(int argc, const char * argv[]) {
    ...
    // Registro de las particulas absorbidas en cada region. +2 por la region
    ...
    for (int ibatch=0; ibatch<nbatch; ibatch++) {
        ...
        for (int ihist=0; ihist<nperbatch; ihist++) {
            ...
            x = 0.0; y = 0.0; z = zbounds[0];   // i.e., frente al atenuador
